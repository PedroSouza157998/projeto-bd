...
CREATE TABLE COPIA (
    ...
    ID INT,
    COD_BIBLIOTECA INT, 
    CONSTRAINT PK_COPIA PRIMARY KEY(ISBN,ID),
...
ID INT,
ID_MULTA VARCHAR(255),
CONSTRAINT PK_DEVOLUCAO PRIMARY KEY(CPF,ISBN,ID),
CONSTRAINT FK_DEVOLUCAO_USUARIO_CPF FOREIGN KEY (CPF) REFERENCES USUARIO(CPF),
CONSTRAINT FK_DEVOLUCAO_COPIA FOREIGN KEY (ISBN,ID) REFERENCES COPIA(ISBN,ID),
...
CREATE TABLE ALUGA (
    ...
    CONSTRAINT PK_ALUGA PRIMARY KEY (CPF, ISBN, ID, DATA_ALUGUEL),
    CONSTRAINT FK_ALUGA_USUARIO FOREIGN KEY (CPF) REFERENCES USUARIO (CPF),
    CONSTRAINT FK_ALUGA_COPIA FOREIGN KEY (ISBN, ID) REFERENCES COPIA (ISBN, ID),
